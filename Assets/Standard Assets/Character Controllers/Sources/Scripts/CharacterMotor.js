...
var movement_offset : float = 0f;
var offset_reached : float = 11.0f;
...
class CharacterMotorMovement {
	...
	var left_timer : float = 0.0;
	var right_timer : float = 0.0;
	var movement_offset : float = 0f;
	var offset_reached : float = 11.0f;
	var pressed_timer: float;
	var forward_speed : float = 0.20;
...
private function UpdateFunction () {
	...
	groundNormal = Vector3.zero;
   	...
   	currentMovementOffset.z = currentMovementOffset.z + .23; //move character forward
   	...
   	if(move_left)
   	{
   		movement_offset = movement_offset + 0.4f;  //constant is shift length. smaller is longer
   		currentMovementOffset.x = currentMovementOffset.x - 0.4f;  //constant is shift speed. bigger is faster
   	}
	...
	if(movement_offset > 10.0f)
	{
   	...
   	if(move_left)
   	{
   		movement_offset = movement_offset + 1.05f;
   		currentMovementOffset.x = currentMovementOffset.x - 1f;
   	}
